...
import { addCart, getCoursesReviewsById, addCartLogged, addDetails } from '../../actions/actions'
...
export default connect(mapStateToProps, { addCart, getCoursesReviewsById, addCartLogged, addDetails })(Details)